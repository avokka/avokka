...
object Dependencies {
  ...
  val scalaTestPlus = "org.scalatestplus" %% "scalacheck-1-17" % "3.2.15.0"
  ...
  val testContainers = "com.dimafeng" %% "testcontainers-scala-scalatest" % "0.40.11"
  ...
  // ce3
  val catsEffect_3 = "org.typelevel" %% "cats-effect" % "3.4.10"
  val catsRetry_3 = "com.github.cb372" %% "cats-retry" % "3.1.0"
  val log4cats_3 = "org.typelevel" %% "log4cats-core"    % "2.5.0"
  val log4catsSlf_3 = "org.typelevel" %% "log4cats-slf4j" % "2.5.0"
  val log4catsNoop_3 = "org.typelevel" %% "log4cats-noop" % "2.5.0"

  /* fs2 */
  val fs2 = "co.fs2" %% "fs2-core" % "2.5.11"
  val fs2IO = "co.fs2" %% "fs2-io" % "2.5.11"
  // ce3
  val fs2_3 = "co.fs2" %% "fs2-core" % "3.4.0"
  val fs2IO_3 = "co.fs2" %% "fs2-io" % "3.4.0"
  ...
  val pureconfig3 = "com.github.pureconfig" %% "pureconfig-core" % "0.17.3"
  val pureconfigF = "com.github.pureconfig" %% "pureconfig-cats-effect2" % "0.17.3"
  val pureconfigF_3 = "com.github.pureconfig" %% "pureconfig-cats-effect" % "0.17.3"
